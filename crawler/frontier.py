...
class Frontier(object):
    def __init__(self, config, restart):
        ...
        self.delay_tracker = {domain: -self.set_delay for domain in self.to_be_downloaded}
    ...
    def place_url_in_dom(url):
        ...
        assign_domain = ""
        if url_comp.netloc == "today.uci.edu" and re.match(r'^(\/department\/information_computer_sciences\/)', url_comp.path):
            assign_domain = "today"
        elif bool(url_domain.group):
